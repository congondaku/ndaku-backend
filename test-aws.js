...
console.log('AWS_ACCESS_KEY_ID_I present:', !!process.env.AWS_ACCESS_KEY_ID_I);
console.log('AWS_SECRET_ACCESS_KEY_K present:', !!process.env.AWS_SECRET_ACCESS_KEY_K);
console.log('AWS_REGION_N:', process.env.AWS_REGION_N);
